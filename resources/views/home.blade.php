...
<section class="hero full-bleed">
    ...
    <p class="hero-sub">
        Welcome to Bookhive – where every book finds its perfect reader.
        Discover, collect, and share your literary treasures in our buzzing community of book lovers.
    </p>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll('.genre-carousel-wrapper, .na-carousel-wrapper').forEach(wrapper => {
